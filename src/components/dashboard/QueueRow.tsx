...
import { useArtifacts, useCreateGitOpsPR } from '@/lib/hooks/use-incidents';
...
export function QueueRow({
  ...
  const createPR                = useCreateGitOpsPR();
  ...
  const handleCreatePr = async () => {
    const result = await createPR.mutateAsync({
      ...
      artifacts: incident.artifactsReady,
    });
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                ...
                {prUrl ? (
                  ...
                  >
                    ...
                    {createPR.isPending ? 'Opening PR…' : 'Push GitOps PR'}
                  </button>
                )}
